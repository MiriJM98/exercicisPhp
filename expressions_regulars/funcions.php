...
{
    preg_match("/^[A-Z]{1}[0-9]{2}[-][0-9]{3,10}[.][A-Z]{2}[0-9]{1}$/", $codi);
    if (preg_match("/^[A-Z]{1}[0-9]{2}[-][0-9]{3,10}[.][A-Z]{2}[0-9]{1}$/", $codi)) {
        echo "El codi $codi és vàlid.";
    } else {
        echo "El codi $codi no és vàlid.";
    }
}
